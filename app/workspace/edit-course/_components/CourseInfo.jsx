...
function CourseInfo({ course, viewCourse}) {
    ...
    if (!courseLayout) return <div>Loading course info...</div>;
    ...
    return (
        ...
        <div className=' flex flex-col gap-3'>
            ...
            <Button onClick={GenerateCourseContent} disabled={loading}>
                ...
                :<Link href={'/course/'+course?.cid}> <Button className='w-full'><PlayCircle/>Continue Learning</Button> </Link> 
            }   
        </div>
        <Image src={course?.bannerImageUrl} alt='banner image' width={400} height={240} className= 'aspect-auto mt-5 md:mt-0 object-cover rounded-2xl'/>
        </div>
    );
}
